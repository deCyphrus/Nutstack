            ...
            {row.map((bolt) => {
              ...
              return (
                <div 
                  ...
                  className={`relative flex flex-col items-center cursor-pointer group select-none transition-transform transition-opacity duration-500 ${isLocked ? 'opacity-60' : ''} ${errorIdx === globalIdx ? 'animate-error-shake' : ''} ${justLockedIdx === globalIdx ? 'animate-lock-burst' : ''}`}
